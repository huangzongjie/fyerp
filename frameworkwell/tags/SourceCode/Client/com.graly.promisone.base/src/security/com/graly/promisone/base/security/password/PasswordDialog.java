package com.graly.promisone.base.security.password;
...
import com.graly.promisone.base.ui.validator.GenericValidator;
...
public class PasswordDialog extends TitleAreaDialog {
	...
	public static final String DIALOG_ID = "com.graly.promisone.base.security.password.PasswordDialog";
...
//		lbConfirmPass.setFont(SWTResourceCache.getFont("Verdana"));
	...
	public boolean validate(){
		...
		if(oldIsNull){
			setMessage(String.format(Message.getString("common.ismandatry"),
			...
			if(user != null ) {
				...
				if(isChangedPassword()) {
					...
					try {
						...
						entityManager.saveEntity(user, Env.getUserId());
