	...
	public void createContent(Composite composite, FormToolkit toolkit) {
		...
		add.addSelectionListener(new SelectionListener() {
				public void widgetSelected(SelectionEvent e) {
					...
					if(adTable.getName().equals("ADUser")) {						
						singleDialog = new UserQueryDialog(e.widget.getDisplay().getActiveShell()
								, listTableManager, null, whereClause, style);
					} else {
						singleDialog = new SingleQueryDialog(e.widget.getDisplay().getActiveShell()
								, listTableManager, null, whereClause, style);
					}
