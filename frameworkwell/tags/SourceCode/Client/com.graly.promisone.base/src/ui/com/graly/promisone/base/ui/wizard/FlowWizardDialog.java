...
public class FlowWizardDialog extends TitleAreaDialog implements IWizardContainer2,
		IPageChangeProvider {
	 ...
	 */
	public FlowWizardDialog(Shell parentShell, IWizard newWizard) {
		super(parentShell);
	 ...
	 */
	private Composite createNextButtons(Composite parent) {
		// increment the number of columns in the button bar
		((GridLayout) parent.getLayout()).numColumns++;
