...
import com.graly.promisone.base.entitymanager.views.TableViewerManager.ColumnSelectionListener;
import com.graly.promisone.base.ui.layout.WeightedTableLayout;

public class FixEntityTableManager extends EntityTableManager {
	
	public FixEntityTableManager(ADTable adTable){
		super(adTable);
	}
