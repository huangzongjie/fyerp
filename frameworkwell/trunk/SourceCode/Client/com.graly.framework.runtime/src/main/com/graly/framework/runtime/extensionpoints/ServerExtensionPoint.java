...
public class ServerExtensionPoint {
	...
	public final static String X_POINT = "com.graly.framework.runtime.server";
    ...
    private ServiceHost loadServiceHost(IConfigurationElement element) throws Exception{
    	...
    	try{
	    	...
	    	host.setHostName(element.getAttribute(A_HOSTNAME));
	    	...
	    	for (IConfigurationElement elem : properties) {
	    		...
	    		host.setProperty(name, elem.getAttribute(A_VALUE));
	    	}
    		return host;
    	} catch (Exception e){
    		throw e;
