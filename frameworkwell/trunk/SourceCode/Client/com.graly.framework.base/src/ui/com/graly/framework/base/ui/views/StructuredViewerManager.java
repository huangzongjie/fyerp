...
public abstract class StructuredViewerManager {
	...
	protected abstract StructuredViewer newViewer(Composite parent, FormToolkit toolkit, int heightHint);
...
//    }
    ...
    public StructuredViewer createViewer(Composite parent, FormToolkit toolkit) {
    	return createViewer(parent, toolkit, null, null, null, 180);
    }
    
    public StructuredViewer createViewer(Composite parent, FormToolkit toolkit, int heightHint) {
    	return createViewer(parent, toolkit, null, null, null, heightHint);
    }
    ...
    public StructuredViewer createViewer(Composite parent, FormToolkit toolkit, String[] columns, String[] columnsHeaders, int[] columnsSize, int heightHint) {
    	if(columns != null && columnsHeaders!= null && columnsSize != null && 
    		...
    		viewer = newViewer(parent, toolkit, heightHint);
    	}
