...
public class SWTResourceCache {
    ...
    static {
		...
		color =new Color(Display.getCurrent(), 55, 114, 221);//浅蓝色
		colorTable.put("Function", color);
		
		color =new Color(Display.getCurrent(), 0, 0, 0);//黑色
		colorTable.put("Black", color);
		
		color =new Color(Display.getCurrent(), 255, 0, 0);//深红色
		colorTable.put("Red", color);
		
		color =new Color(Display.getCurrent(), 253, 72, 34);//红色
		colorTable.put("Held", color);
		
		color =new Color(Display.getCurrent(), 57, 244, 43);//绿色
		colorTable.put("Run", color);
		
		color =new Color(Display.getCurrent(), 255, 128, 0);//橙色
		colorTable.put("Alarm", color);
    }
    /**
