...
public class SingleQueryDialog extends ExtendDialog {
	
	Logger logger = Logger.getLogger(SingleQueryDialog.class);
	...
	public SingleQueryDialog() {
		super();
	}
	
	public SingleQueryDialog(TableListManager listTableManager,
	...
	public SingleQueryDialog(StructuredViewer viewer, Object object) {
		super();
