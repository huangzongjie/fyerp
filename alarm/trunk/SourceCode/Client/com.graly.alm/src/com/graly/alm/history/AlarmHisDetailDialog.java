...
public class AlarmHisDetailDialog extends InClosableTitleAreaDialog {
	private static final Logger logger = Logger.getLogger(AlarmHisDetailDialog.class);
	private static int MIN_DIALOG_WIDTH = 700;
	private static int MIN_DIALOG_HEIGHT = 350;
	private AlarmHisDetailSection alarmHisDetailSection;
	protected ADTable adTable;
	protected ManagedForm managedForm;
	private AlarmHis alarmHis;

	public AlarmHisDetailDialog(Shell parent) {
		super(parent);
	}

	public AlarmHisDetailDialog(Shell shell, ADTable adTable, AlarmHis alarmHis) {
		this(shell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		String dialogTitle = String.format(Message.getString("alm.alarmhis_detials"));
	...
	protected void createFormContent(Composite composite) {
		...
		configureBody(body);
		alarmHisDetailSection = new AlarmHisDetailSection(adTable, alarmHis);
