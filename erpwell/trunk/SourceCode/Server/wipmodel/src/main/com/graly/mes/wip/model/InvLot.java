...
@MappedSuperclass
public class InvLot extends ProcessUnit {
	
	private static final long serialVersionUID = 1L;
	
	public static final String LOTTYPE_MATERIAL = "MATERIAL";
	
	public static final String LOTTYPE_BATCH_A = "BATCHA";
	public static final String LOTTYPE_BATCH = "BATCH";
	
	public static final String LOTTYPE_SERIAL = "SERIAL";
	
	public static final String POSITION_IQC = "IQC";         	//质检生成
	public static final String POSITION_GEN = "GEN";         	//手动生成
	public static final String POSITION_PIN = "PIN";     		//采购入库
	public static final String POSITION_OIN = "OIN";     		//其它入库
	public static final String POSITION_RIN = "RIN";     		//入库
	public static final String POSITION_TRF = "TRF";     		//调拨
	public static final String POSITION_INSTOCK = "INSTOCK"; 	//仓库中
	public static final String POSITION_WIP = "WIP";         	//生产线中
	public static final String POSITION_WIN = "WIN";     		//生产入库
	public static final String POSITION_PREOUT = "PREOUT";   	//出库单
	public static final String POSITION_SOU = "SOU";         	//销售出库
	public static final String POSITION_OOU = "OOU";         	//其它出库
	public static final String POSITION_OUT = "OUT";         	//出库
	...
	@Column(name="TRANSFER_LINE_RRN")
	private Long transferLineRrn;
	...
	public void setTransferLineRrn(Long transferLineRrn) {
		this.transferLineRrn = transferLineRrn;
	}

	public Long getTransferLineRrn() {
		return transferLineRrn;
	}
	...
	public Boolean getIsPackage(){
		return "Y".equalsIgnoreCase(this.isPackage) ? true : false; 
	}

	public void setIsPackage(Boolean isPackage) {
		this.isPackage = isPackage ? "Y" : "N";
	}
