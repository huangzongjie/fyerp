...
public abstract class XmlUtil {
	...
	public static Iterator<Node> elementIterator(Element element, String tagName) {
		return elements(element, tagName).iterator();
	}

	public static List<Node> elements(Element element, String tagName) {
		NodeList nodeList = element.getElementsByTagName(tagName);
		List<Node> elements = new ArrayList<Node>(nodeList.getLength());
	...
	public static Iterator<Node> elementIterator(Element element) {
		return elements(element).iterator();
	}

	public static List<Node> elements(Element element) {
	...
	public static Element element(Element element) {
		...
		List<Node> elements = elements(element);
		if (!elements.isEmpty()) {
