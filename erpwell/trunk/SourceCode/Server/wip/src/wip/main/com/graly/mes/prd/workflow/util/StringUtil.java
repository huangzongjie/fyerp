...
public class StringUtil implements Serializable {
	...
	public static Object toTypeObject(String object, String type) {
		try {
			if (object != null && !"".equalsIgnoreCase(object.trim())) {
			...
			throw new JbpmException("toTypeObject object'" + object + "', type'" + type + "'", e);
		}
	}
