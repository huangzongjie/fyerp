...
<%
		...
		String viewerVersion = "2.3.2";
		String engineVersion = "2.3.2";
	%>
</HEAD>
<BODY>
<!-- Page banner -->
<TABLE class=banner-area cellSpacing=0 cellPadding=0 width="100%"
	border=0>
	<TBODY>
		<TR>
			<TD width=116 bgColor=black><a href="http://www.eclipse.org/">
			<IMG src="webcontent/birt/images/EclipseBannerPic.jpg" border=0
				width="115" height="50"> </a></TD>
			<TD width=637><IMG height=53
				src="webcontent/birt/images/gradient.jpg" width=282 border=0>
			</TD>
			<TD vAlign=center align=right width=250><a class="birt"
				href="http://www.eclipse.org/birt"> <!-- Temporary BIRT header -->
			<SPAN
				style="PADDING-RIGHT: 20pt; FONT-WEIGHT: bold; FONT-SIZE: 20px; COLOR: #e8e8ff; FONT-FAMILY: arial, sans-serif">
			BIRT </SPAN> </a></TD>
		</TR>
	</TBODY>
</TABLE>
	...
	<TBODY>
		<TR>
			<TD class=content
				...
				vAlign=top width="1077"><!-- Page title -->
			<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
				<TBODY>
					<TR>
						<TD vAlign=top><span class="indextop">BIRT viewer has
						been installed.</span>
						<p>&nbsp;
						</TD>
			...
			<!-- Content area -->
			<p>Thank you for your choosing BIRT (Business Intelligence
			Reporting Tool).</p>
			...
			<p><a
				href="<%= request.getContextPath( ) + "/frameset?__report=test.rptdesign&sample=my+parameter" %>">View
			Example</a>
			</TD>
		</TR>
	</TBODY>
