package com.graly.erp.pdm.material.refercedoc;
...
public class ReferceDocSection extends EntitySection{
	private Material material;

	public ReferceDocSection(ADTable table, Material material) {
		super(table);
	...
	protected void createSectionContent(Composite client) {
		...
		for (ADTab tab : getTable().getTabs()) {
			...
			EntityForm itemForm = new EntityForm(getTabs(), SWT.NONE, material, tab, mmng);
