...
public class OptionalInfoForm extends ChildEntityForm {
	private static final Logger logger = Logger.getLogger(OptionalInfoForm.class);
	private static final String FIELD_UnitQty = "unitQty";
	private static final String FIELD_Des = "description";
	private OptionalDialog parentDialog;

	public OptionalInfoForm(Composite parent, int style, Object object, ADTable table,
	...
	public void setParentDialog(OptionalDialog parentDialog) {
