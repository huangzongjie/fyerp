...
public class MaterialHisItemAdapter extends AbstractItemAdapter{
	private static final Logger logger = Logger.getLogger(MaterialHisItemAdapter.class);
	protected static final Object[] EMPTY = new Object[0];
	protected Long version;
	public MaterialHisItemAdapter(Long version) {
...
//				pdmManager.getLastBomDetails(mr.getObjectRrn());
				List<Bom> list = pdmManager.getChildrenBoms(mr.getObjectRrn(),version,BigDecimal.ONE);
