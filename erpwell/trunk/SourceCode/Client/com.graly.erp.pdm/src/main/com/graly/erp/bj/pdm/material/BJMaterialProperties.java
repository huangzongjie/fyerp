...
public class BJMaterialProperties extends EntityProperties {
	...
	public BJMaterialProperties() {
		super();
	}

	public BJMaterialProperties(EntityBlock masterParent, ADTable table) {
	...
	protected void createSectionContent(Composite client) {
		...
		for (ADTab tab : getTable().getTabs()) {
			...
			Form itemForm = null;
			itemForm = new BJLotTypeForm(getTabs(), SWT.NONE, tab, mmng);
