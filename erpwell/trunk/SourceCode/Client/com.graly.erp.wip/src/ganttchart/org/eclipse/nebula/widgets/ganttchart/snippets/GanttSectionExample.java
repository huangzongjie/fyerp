package org.eclipse.nebula.widgets.ganttchart.snippets;
...
public class GanttSectionExample {
	...
	public static void main(String[] args) {
		...
		eventOne.setStatusColor(ColorCache.getColor(255, 255, 255)); //70, 132, 96
		...
		gs2.setWeekdayBackgroundColorTop(ColorCache.getColor(242, 231, 215)); //242, 231, 215
