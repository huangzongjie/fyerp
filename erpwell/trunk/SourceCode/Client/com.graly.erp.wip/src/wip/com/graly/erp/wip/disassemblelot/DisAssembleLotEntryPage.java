...
public class DisAssembleLotEntryPage extends FormPage {
	private static final Logger logger = Logger.getLogger(DisAssembleLotEntryPage.class);
	private ADTable table;
	private DisAssembleLotSection searchByLotSection;
	protected IManagedForm form;
	
	public DisAssembleLotEntryPage(FormEditor editor, String id, String name,
			ADTable table) {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		searchByLotSection = new DisAssembleLotSection(table);
