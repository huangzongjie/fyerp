...
public class MOAlternateDetailForm extends ChildEntityForm {
	private static final Logger logger = Logger.getLogger(MOAlternateDetailForm.class);
	private static final String FIELD_UnitQty = "unitQty";
	private static final String FIELD_Des = "description";
	private MOAlternateDialog parentDialog;

	public MOAlternateDetailForm(Composite parent, int style, Object object, ADTable table,
	...
	public void setParentDialog(MOAlternateDialog parentDialog) {
