...
public class VirtualHouseLineLotDialog  extends InClosableTitleAreaDialog {
	private static final Logger logger = Logger.getLogger(VirtualHouseLineLotDialog.class);
...
//	public static final String TableName = "VirtualHouseLineLot";
	protected MovementWorkShopVirtualHouse virtualHouse;//movementOut
	protected MovementWorkShopLine outLine;//outLine
	...
	public VirtualHouseLineLotDialog(Shell shell) {
		super(shell);
	}
	
	public VirtualHouseLineLotDialog(Shell shell, ADTable table){
		this(shell);
		this.table = table;
	}
	
	public VirtualHouseLineLotDialog(Shell shell, ADTable table, List<MovementWorkShopLine> lines){
		this(shell);
		this.table = table;
		this.lines = lines;
	}
	...
	public VirtualHouseLineLotDialog(Shell shell, Object out, Object movementInLine,
			List<MovementWorkShopLine> lines, boolean isView) {
		this(shell, out, movementInLine, isView);
		this.lines = lines;
	}
	
	public VirtualHouseLineLotDialog(Shell shell, Object parent, Object child, boolean isView) {
		this(shell);
		this.virtualHouse = (MovementWorkShopVirtualHouse)parent;
		this.outLine = (MovementWorkShopLine)child;
		this.isView = isView;
	}
	
	protected void createSection(Composite composite) {
//		lotSection = new VirtualHouseLotSection(virtualHouse, outLine, table, this, isView);
		lotSection = new VirtualHouseLotSection(table, virtualHouse, outLine, lines, this, isView);
...
//			return UI.showConfirm(Message.getString("inv.confirm_save_before_exit"));
	...
	public List<MovementWorkShopLine> getLines() {
		return lines;
	}

	public void setLines(List<MovementWorkShopLine> lines) {
		this.lines = lines;
	}
}
