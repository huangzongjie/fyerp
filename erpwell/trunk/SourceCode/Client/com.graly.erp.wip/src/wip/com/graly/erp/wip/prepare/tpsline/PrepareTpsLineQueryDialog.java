...
public class PrepareTpsLineQueryDialog extends ExtendDialog {
	private InnerQueryDialog queryDialog;
	
	public PrepareTpsLineQueryDialog() {
		super();
		queryDialog = new InnerQueryDialog(UI.getActiveShell());
	}

	public PrepareTpsLineQueryDialog(Shell parent) {
		super(parent);
	}

	public PrepareTpsLineQueryDialog(String tableId, Object parent) {
	...
	class InnerQueryDialog extends EntityQueryDialog{
		...
		@Override
		protected void okPressed() {
			PrepareTpsLineQueryDialog.this.okPressed();
			createWhereClause();
