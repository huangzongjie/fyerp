...
public class MoWmsOutSection extends MasterSection {
	private static final Logger logger = Logger.getLogger(MoWmsOutSection.class);
	protected ToolItem itemDelete;
	protected StockIn selectSi;

	
	public MoWmsOutSection(EntityTableManager tableManager) {
		super(tableManager);
	}
