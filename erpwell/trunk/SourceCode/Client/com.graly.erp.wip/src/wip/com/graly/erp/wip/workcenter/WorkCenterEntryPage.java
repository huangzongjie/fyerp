...
public class WorkCenterEntryPage extends FormPage {
	private static final Logger logger = Logger.getLogger(WorkCenterEntryPage.class);
	public static final String TABLE_NAME = "WIPWorkCenter";
	protected ADTable adTable;
	protected WorkCenterSection wcSection;
	
	public WorkCenterEntryPage(FormEditor editor, String id, String name,
			ADTable table) {
	...
	protected void createFormContent(IManagedForm managedForm) {		
		...
		wcSection = new WorkCenterSection(((EntityEditorInput)this.getEditor().getEditorInput()).getTable(), adTable);
