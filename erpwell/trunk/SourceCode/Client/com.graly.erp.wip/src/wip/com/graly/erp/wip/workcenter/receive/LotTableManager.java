...
public class LotTableManager extends TableListManager {
	...
	private ReceiveChildSection parentSection;
	private CellEditor[] cellEditor;
	private boolean canEdit = true;
	
	public LotTableManager(ReceiveChildSection parentSection) {
		super(null);
	...
	public LotTableManager(ADTable adTable, int style) {
		super(adTable);
    ...
    class TextCellModifier implements ICellModifier {
		...
		public boolean canModify(Object element, String property) {
			if(element instanceof Lot) {
				Lot lot = (Lot)element;
				if(canEdit && parentSection.isBatchLot(lot)) {
					return true;
				}
			}
			return false;
