...
public class WCTOutQtySetupDialog extends TitleAreaDialog {
	...
	public WCTOutQtySetupDialog(Shell parentShell, WCTMovementLine movementLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
		this.wctMovementLine = movementLine;
		this.lot = lot;
	...
	protected void setQtyContent() {
		...
		if(wctMovementLine != null && qtyOnhand != null && qtyOnhand.compareTo(wctMovementLine.getQtyMovement()) > 0) {
			txtOutQty.setText(wctMovementLine.getQtyMovement().toString());
		} else {
