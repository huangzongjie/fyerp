...
public class WipCalendarDayEntryPage extends FormPage {
	...
	public WipCalendarDayEntryPage(FormEditor editor, String id, String name,
			ADTable table) {
	...
	protected void createSection(ADTable adTable) {
		calendarDaySection = new WipCalendarDaySection(new CalendarDayListManager(adTable), BusinessCalendar.CALENDAR_MANUFACTURE);
	}
