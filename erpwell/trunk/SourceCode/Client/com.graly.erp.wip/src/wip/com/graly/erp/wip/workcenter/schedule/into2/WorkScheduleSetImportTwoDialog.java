...
public class WorkScheduleSetImportTwoDialog extends ExtendDialog {
	...
	public WorkScheduleSetImportTwoDialog() {
		super();
		queryDialog = new PrInternalQueryDialog(UI.getActiveShell());
	}
	
	public WorkScheduleSetImportTwoDialog(boolean isCreateQuery) {
	...
	protected void setQueryDialogToSection() {
		if(getParent() instanceof EntityEditor){
			...
			if(editor.getActivePageInstance() instanceof WorkScheduleImportTwoSection){
				WorkScheduleImportTwoSection page = (WorkScheduleImportTwoSection) editor.getActivePageInstance();
				WorkScheduleImportTwoSection section = page.getImportSection();
			//	queryDialog.setIRefresh(section);
				section.setQueryDialog(queryDialog);
				((WorkScheduleImportTwoSection)section).setExtendDialog(this);
			}
		}
	}
	...
	class PrInternalQueryDialog extends EntityQueryDialog {
		...
		protected void okPressed() {
			WorkScheduleImportTwoEditor editor = (WorkScheduleImportTwoEditor) getParent();
			WorkScheduleImportTwoEntryPage page = (WorkScheduleImportTwoEntryPage) editor.getActivePageInstance();
			WorkScheduleImportTwoSection section = page.getImportSection();
