...
public class WorkCenterDialog extends ExtendDialog {
	private static final Logger logger = Logger.getLogger(WorkCenterDialog.class);
...
//		}
	...
	protected void buttonPressed(int buttonId) {
		if(buttonId == IDialogConstants.OK_ID) {
			if(selectedWC == null)
				return;
			WorkCenterEditor editor = (WorkCenterEditor) getParent();
			WorkCenterEntryPage page = (WorkCenterEntryPage) editor.getActivePageInstance();
