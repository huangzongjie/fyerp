...
public class VirtualHouseQtySetupDialog extends TitleAreaDialog {
	protected ManagedForm managedForm;
	protected MovementWorkShopLine workShopLine;
	protected Lot lot;
	protected Text txtOutQty;
	protected BigDecimal inputQty, qtyOnhand = BigDecimal.ZERO;
	protected Warehouse warehouse;

	public VirtualHouseQtySetupDialog(Shell parentShell, MovementWorkShopLine workShopLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
	...
	protected boolean validate() {
		try {
			...
			if(inputQty.compareTo(BigDecimal.ZERO) <= 0) {
				setErrorMessage(String.format(Message.getString("common.lessthan"),getMovementQtyLabel(),"0"));
				return false;
			}
		} catch(Exception e) {
