...
public class ByLotVirtualHouseInputQtyDialog extends InClosableTitleAreaDialog  {
	private static final Logger logger = Logger.getLogger(ByLotVirtualHouseInputQtyDialog.class);
	...
	protected ByLotVirtualHouseInputQtySection virtualHouseLotSection;

	protected List<MovementLine> lines;
	public ByLotVirtualHouseInputQtyDialog(Shell shell) {
		super(shell);
	}
	...
	protected void createSection(Composite composite) {
		virtualHouseLotSection = new ByLotVirtualHouseInputQtySection(table, this);
		virtualHouseLotSection.createContents(managedForm, composite);
	}

	public ByLotVirtualHouseInputQtySection getVirtualHouseLotSection() {
		return virtualHouseLotSection;
	}

	public void setVirtualHouseLotSection(
			ByLotVirtualHouseInputQtySection virtualHouseLotSection) {
