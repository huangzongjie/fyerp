...
public class WorkScheduleImportProgress  implements IRunnableWithProgress {
	private static final Logger logger = Logger.getLogger(WorkScheduleImportProgress.class);
...
//	protected Mps mps;
	...
	public WorkScheduleImportProgress(Object mps, String fileUrl, ADTable adTable,
