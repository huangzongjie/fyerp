...
public class PurchaseMaterialModifyDialog extends InClosableTitleAreaDialog {
	...
	private RepScheResult repScheResult;
	private EntityForm entityForm;

	public PurchaseMaterialModifyDialog(Shell parentShell, RepScheResult repScheResult,ADTable adTable) {
		super(parentShell);
		this.repScheResult = repScheResult;
	...
	protected Control createDialogArea(Composite parent) {
		...
		configureBody(body);
		entityForm = new EntityForm(body, SWT.NONE, repScheResult, adTable, null);
...
//		createContent(body, toolkit);
	...
	public RepScheResult getRepScheResult() {
		return repScheResult;
	}

	public void setRepScheResult(RepScheResult repScheResult) {
		this.repScheResult = repScheResult;
	}
