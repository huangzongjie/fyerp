...
public class BomItemAdapter extends AbstractItemAdapter {
	...
	public String getText(Object object, String id) {
		if(object instanceof Bom){
			...
			}else if(id.equalsIgnoreCase(BomConstant.STAND_TIME_BOM)){
				Material material = bom.getChildMaterial();
				if(material!=null){
					return material.getStandTime() == null ? "" : material.getStandTime().toString();
				}
				return "";
			}else if(id.equalsIgnoreCase(BomConstant.PROCESS_NAME)){
				Material material = bom.getChildMaterial();
				if(material!=null){
					return material.getProcessName() == null ? "" : material.getProcessName();
				}
				return "";
			}
		}
