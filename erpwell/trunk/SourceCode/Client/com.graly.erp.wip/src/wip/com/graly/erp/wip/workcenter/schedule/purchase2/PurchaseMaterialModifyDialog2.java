 ...
 * 用于修改质检备注信息
 */
public class PurchaseMaterialModifyDialog2 extends InClosableTitleAreaDialog {
	protected ManagedForm managedForm;
	private ADTable adTable;
	private VRepScheResult2 mc;
	private EntityForm entityForm;

	public PurchaseMaterialModifyDialog2(Shell parentShell, VRepScheResult2 mc,ADTable adTable) {
		super(parentShell);
		this.mc = mc;
...
//		createContent(body, toolkit);
	...
	public VRepScheResult2 getMc() {
		return mc;
	}

	public void setMc(VRepScheResult2 mc) {
		this.mc = mc;
	}
