...
public class MOChildrenDialog extends InClosableTitleAreaDialog {
	...
	public MOChildrenDialog(Shell parentShell, ManufactureOrder mo) {
		super(parentShell);
		this.mo = mo;
	}
	...
	protected void initTableContent() {
		try {
			if(mo != null) {
				...
				input = wipManager.getMoLineChildrenForMo(Env.getOrgRrn(), mo.getObjectRrn());            
				refresh();				
			}
        } catch (Exception e) {
        	ExceptionHandlerManager.asyncHandleException(e);
