...
public class BJPurInLineProperties extends ChildEntityProperties {
	private String PREFIX = " movementRrn = '";
	
	public BJPurInLineProperties() {
		super();
    }
	
	public BJPurInLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
	...
	protected void createSectionContent(Composite client) {
		...
		//init Locator
		BJPurInLineEntryBlock block = (BJPurInLineEntryBlock)getMasterParent();
...
//		new ToolItem(tBar, SWT.SEPARATOR);
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			BJPurInLineEntryBlock block = (BJPurInLineEntryBlock)this.getMasterParent();
