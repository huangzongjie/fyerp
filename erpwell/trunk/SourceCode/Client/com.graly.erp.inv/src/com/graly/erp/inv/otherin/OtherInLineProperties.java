...
public class OtherInLineProperties extends ChildEntityProperties {
	protected TableListManager listTableManager;
	protected Object parentObject;
	private boolean flag;

	public OtherInLineProperties() {
		super();
	}

	public OtherInLineProperties(EntityBlock masterParent, ADTable table, Object parentObject,boolean flag) {
	...
	protected void createSectionContent(Composite client) {
		...
		OtherInLineEntryBlock block = (OtherInLineEntryBlock)getMasterParent();
...
//    	}
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			OtherInLineEntryBlock block = (OtherInLineEntryBlock) this.getMasterParent();
