...
public class InLineProperties extends ChildEntityProperties {
	...
	public InLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
	...
	protected void createSectionContent(Composite client) {
		...
		//init Locator
		InLineEntryBlock block = (InLineEntryBlock)getMasterParent();
...
//		new ToolItem(tBar, SWT.SEPARATOR);
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			InLineEntryBlock block = (InLineEntryBlock)this.getMasterParent();
