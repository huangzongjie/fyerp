 ...
 */
public class LotSelectFromDbDialog extends OutLineLotDialog {
	protected List<Lot> selectedLots;

	public LotSelectFromDbDialog(Shell shell, Object parent, Object child, List<Lot> selectedLots) {
	...
	protected void createSection(Composite composite) {
		lotSection = new LotSelectFromDbSection(movementOut, outLine, table, selectedLots, this);
