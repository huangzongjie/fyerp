...
import com.graly.erp.inv.model.VIqcLine;
...
public class IqcLineSection2 extends MasterSection {
	private static final Logger logger = Logger.getLogger(IqcLineSection2.class);
	
	private static final String TABLE_NAME = "INVIqcLineStatistics2";
	private ADTable adTable;
	
	public IqcLineSection2() {
		super();
	}
	
	public IqcLineSection2(EntityTableManager tableManager) {
		super(tableManager);
	}
