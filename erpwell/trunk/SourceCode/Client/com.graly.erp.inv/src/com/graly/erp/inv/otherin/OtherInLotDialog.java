...
public class OtherInLotDialog extends LotDialog {
	...
	public OtherInLotDialog(Shell shell) {
		super(shell);
	}

	public OtherInLotDialog(Shell shell, MovementIn in, MovementLine movementInLine) {
		super(shell);
		this.in = in;
	...
	protected void createSection(Composite composite) {
		...
		lotSection = new OtherInLotSection(adTable, in, movementInLine, lines, isView);
		((OtherInLotSection)lotSection).setInType(inType);
