...
public class NewRackLotDialog2 extends InClosableTitleAreaDialog {
	private static final Logger logger = Logger.getLogger(NewRackLotDialog2.class);
	...
	protected NewRackLotSection lotSection;

	public NewRackLotDialog2(Shell shell, ADTable table) {
		this(shell);
		this.table = table;
	}

	public NewRackLotDialog2(Shell shell) {
		super(shell);
	}

	protected void createSection(Composite composite) {
		lotSection = new NewRackLotSection(table, this);
