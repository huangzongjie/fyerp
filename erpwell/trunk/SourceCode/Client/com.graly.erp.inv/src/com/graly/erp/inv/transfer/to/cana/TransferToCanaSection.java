...
public class TransferToCanaSection extends MasterSection {
	...
	public TransferToCanaSection(EntityTableManager tableManager){
		super(tableManager);
	}
...
//		}
	...
	protected void newAdapter() {
		...
		TransferToCanaLineDialog olbd = new TransferToCanaLineDialog(UI.getActiveShell(),
	...
	protected void editAdapter() {
		try {
			if(selectedMt != null && selectedMt.getObjectRrn() != null) {
				...
				TransferToCanaLineDialog cd = new TransferToCanaLineDialog(UI.getActiveShell(),
