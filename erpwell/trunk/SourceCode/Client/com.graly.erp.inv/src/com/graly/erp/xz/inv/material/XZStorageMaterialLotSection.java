...
public class XZStorageMaterialLotSection extends LotMasterSection {
	private VStorageMaterial selectedLine;
	protected ToolItem itemPrint;
	
	public XZStorageMaterialLotSection(){
		super();
	}
	
	public XZStorageMaterialLotSection(ADTable adTable, LotDialog parentDialog, VStorageMaterial selectedLine) {
