...
public class IqcSelectPage extends FlowWizardPage {
	private static final Logger logger = Logger.getLogger(IqcSelectPage.class);
	private static String IQClINESELECT_NEXT = "iqcLineSelect";

	private IqcCreateWizard wizard;
	private IqcSelectSection section;
	private Iqc selectedIqc;
	
	public IqcSelectPage(String pageName, Wizard wizard, String defaultDirect) {
	...
	public void createControl(Composite parent) {		
        ...
        // create section
		section = new IqcSelectSection(adTable, this);
	...
	public IqcSelectSection getSection() {
		return section;
	}
}
