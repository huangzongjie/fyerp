...
public class WorkShopDelLotTrsSection extends WorkShopDeliveryLineLotSection {
	private static final Logger logger = Logger.getLogger(WorkShopDelLotTrsSection.class);
	...
	protected MovementWorkShopDelivery wsDelivery;
	

	public WorkShopDelLotTrsSection(ADTable adTable, WorkShopDeliveryLineLotDialog parentDialog) {
...
//			}
	...
	protected void saveAdapter() {
		try {
			if (validate()) {
				...
				INVManager invManager = Framework.getService(INVManager.class);
				wsDelivery = (MovementWorkShopDelivery) invManager.saveMovementWorkShopDeliveryLine(wsDelivery, lines,
						Env.getUserRrn());
	...
	protected MovementWorkShopDelivery createMovementTrs() {
		...
		MovementWorkShopDelivery trs = new MovementWorkShopDelivery();
		trs.setOrgRrn(Env.getOrgRrn());
		trs.setDocType(MovementWorkShopDelivery.DOCTYPE_DEL);
	...
	protected MovementWorkShopLine generateLine(List<MovementWorkShopLineLot> lineLots,
		...
		line.setLineStatus(MovementWorkShopDelivery.STATUS_DRAFTED);
	...
	public MovementWorkShopDelivery getWsDelivery() {
		return wsDelivery;
	}

	public void setWsDelivery(MovementWorkShopDelivery wsDelivery) {
