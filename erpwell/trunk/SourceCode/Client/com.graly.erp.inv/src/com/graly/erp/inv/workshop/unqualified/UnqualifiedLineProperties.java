...
public class UnqualifiedLineProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(UnqualifiedLineProperties.class);
	...
	public UnqualifiedLineProperties() {
		super();
	}
	
	public UnqualifiedLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
		this(masterParent, table, parentObject, false);
	}
	
	public UnqualifiedLineProperties(EntityBlock masterParent, ADTable table, Object parentObject, boolean flag) {
	...
	public void refresh() {
		super.refresh();
		UnqualifiedLineEntryBlock block = (UnqualifiedLineEntryBlock)getMasterParent();
		...
		try {
			...
			if (getAdObject() != null) {
				...
				if (saveFlag) {
					...
					MovementWorkShopUnqualified mm = (MovementWorkShopUnqualified)block.getParentObject();
...
//						newAdapter();
					...
					line = invManager.saveMovementWorkShopUnqualifiedLine(mm, line, Env.getUserRrn());
	...
	protected boolean isContainsSameMaterialInLines(MovementWorkShopUnqualified mm, MovementWorkShopLine line) {
	...
	protected List<MovementWorkShopLineLot> getLineLotList(MovementWorkShopUnqualified mtrs, MovementWorkShopLine line) throws Exception{
...
//				if (confirmDelete) {
//					INVManager invManager = Framework.getService(INVManager.class);
//					invManager.deleteMovementWorkShopUnqualifiedLine((MovementWorkShopLine)getAdObject(), Env.getUserRrn());
//					// 刷新父对象
...
//		}
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			UnqualifiedLineEntryBlock block = (UnqualifiedLineEntryBlock)this.getMasterParent();
