...
public class GenerateLotTableManager extends LotTableManager {
	...
	public GenerateLotTableManager(ADTable adTable) {
		super(adTable, "Serial");
	}
...
//		headerLabels = new LinkedHashMap<String, String>();
    	return new String[]{LotId, MaterialId, MaterialName, DisplayName_LotQty};
    }
