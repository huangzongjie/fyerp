...
public class TransferToCanaLineLotSection extends LotMasterSection {
	private static final Logger logger = Logger.getLogger(TransferToCanaLineLotSection.class);
	...
	public TransferToCanaLineLotSection(TransferToCanaLineLotDialog parentDialog, ADTable adTable) {
	...
	public TransferToCanaLineLotSection(TransferToCanaLineLotDialog olld, ADTable adTable,
...
//            	this.setEnabled(false);
	...
	protected void saveAdapter() {
		try {
			if(validateAll()) {
				INVManager invManager = Framework.getService(INVManager.class);
				mt = invManager.saveMovementTransferLineToCana(mt, lines, Env.getOrgRrn());
				UI.showInfo(Message.getString("common.save_successed"));
				setPrintabled(true);
				setIsSaved(true);
				((TransferToCanaLineLotDialog)parentDialog).buttonPressed(IDialogConstants.CANCEL_ID);
			}
		} catch(Exception e) {
