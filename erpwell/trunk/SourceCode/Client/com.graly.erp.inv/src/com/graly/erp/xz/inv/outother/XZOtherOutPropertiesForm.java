 ...
 * */
public class XZOtherOutPropertiesForm extends  ChildEntityForm{

	private static final Logger logger = Logger.getLogger(XZOtherOutPropertiesForm.class);
	
	public XZOtherOutPropertiesForm(Composite parent, int style, Object object,
    ...
    public SearchField createSearchField(String id, String label, ADTable adTable,
    	...
    	XZSearchField fe = new XZSearchField(id, adTable, refTable, whereClause, style);
    	fe.setLabel(label);
    	return fe;
    }
