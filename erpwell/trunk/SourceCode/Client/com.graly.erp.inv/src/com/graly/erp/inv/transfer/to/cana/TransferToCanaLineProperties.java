...
public class TransferToCanaLineProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(TransferToCanaLineProperties.class);
	...
	public TransferToCanaLineProperties() {
		super();
	}
	
	public TransferToCanaLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
		this(masterParent, table, parentObject, false);
	}
	
	public TransferToCanaLineProperties(EntityBlock masterParent, ADTable table, Object parentObject, boolean flag) {
	...
	protected void createSectionContent(Composite client) {
		...
		//Locator第一次赋值
		TransferToCanaLineEntryBlock block = (TransferToCanaLineEntryBlock)getMasterParent();
...
//						newAdapter();
					...
					// 调用savePOLine()方法
					line = invManager.saveMovementTransferLineToCana(mm, line, Env.getUserRrn());
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			TransferToCanaLineEntryBlock block = (TransferToCanaLineEntryBlock)this.getMasterParent();
