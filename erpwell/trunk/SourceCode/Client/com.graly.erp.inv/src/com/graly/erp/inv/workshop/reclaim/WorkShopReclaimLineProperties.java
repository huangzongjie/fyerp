...
public class WorkShopReclaimLineProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(WorkShopReclaimLineProperties.class);
	...
	public WorkShopReclaimLineProperties() {
		super();
	}
	
	public WorkShopReclaimLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
		this(masterParent, table, parentObject, false);
	}
	
	public WorkShopReclaimLineProperties(EntityBlock masterParent, ADTable table, Object parentObject, boolean flag) {
	...
	public void refresh() {
		super.refresh();
		WorkShopReclaimLineEntryBlock block = (WorkShopReclaimLineEntryBlock)getMasterParent();
		...
		try {
			...
			if (getAdObject() != null) {
				...
				if (saveFlag) {
					...
					MovementWorkShopReclaim mm = (MovementWorkShopReclaim)block.getParentObject();
...
//						newAdapter();
					...
					line = invManager.saveMovementWorkShopReclaim(mm, line, Env.getUserRrn());
	...
	protected boolean isContainsSameMaterialInLines(MovementWorkShopReclaim mm, MovementWorkShopLine line) {
	...
	protected List<MovementWorkShopLineLot> getLineLotList(MovementWorkShopReclaim mtrs, MovementWorkShopLine line) throws Exception{
	...
	protected void deleteAdapter() {
		if(!MovementWorkShopReclaim.STATUS_DRAFTED.equals( ((MovementWorkShopLine)getAdObject()).getLineStatus()) ) {
			return;
		}
		try {
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			WorkShopReclaimLineEntryBlock block = (WorkShopReclaimLineEntryBlock)this.getMasterParent();
