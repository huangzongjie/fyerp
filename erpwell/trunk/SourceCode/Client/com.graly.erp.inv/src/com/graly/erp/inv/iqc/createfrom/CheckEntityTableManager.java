...
public class CheckEntityTableManager extends EntityTableManager {
	...
	private ReceiptLineSelectSection parentReceiptLineSection;
	
	public CheckEntityTableManager(ADTable adTable, ReceiptLineSelectSection parentReceiptLineSection){
		super(adTable);
		this.parentReceiptLineSection = parentReceiptLineSection;
	}
	...
	private void updateParentSection(boolean isChecked) {
		if(parentReceiptLineSection != null) {
			parentReceiptLineSection.updateParentPage(isChecked);
		}
	}
