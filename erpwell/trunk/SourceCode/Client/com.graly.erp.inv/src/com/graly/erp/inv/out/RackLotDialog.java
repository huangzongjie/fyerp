...
public class RackLotDialog extends LotDialog {
	...
	public RackLotDialog(Shell shell) {
		super(shell);
	}
	
	public RackLotDialog(Shell shell, Object parent, Object child,  boolean isView) {
		this(shell);
	...
	public RackLotDialog(Shell shell, Object out, Object movementInLine,
	...
	protected void createSection(Composite composite) {
		lotSection = new RackLotSection(table, movementOut, outLine, lines, this, isView);
