...
public class XZInOutQuerySection extends MasterSection {
private static final Logger logger = Logger.getLogger(XZInOutQuerySection.class);
	protected ToolItem itemView;

	public XZInOutQuerySection(EntityTableManager tableManager) {
		super(tableManager);
		setWhereClause(" 1 <> 1");
	}
