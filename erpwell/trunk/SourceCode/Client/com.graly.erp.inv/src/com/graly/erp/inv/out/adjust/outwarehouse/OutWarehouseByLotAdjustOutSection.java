...
public class OutWarehouseByLotAdjustOutSection extends ByLotAdjustOutSection {
	protected MovementOut out;
	
	public OutWarehouseByLotAdjustOutSection(ADTable adTable,
