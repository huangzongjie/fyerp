...
public class BJOtherOutSection extends OutSection {	
	private static final Logger logger = Logger.getLogger(BJOtherOutSection.class);
	private static final String TABLE_NAME = "BJINVMovementOutOtherLine";
	...
	public BJOtherOutSection(EntityTableManager tableManager){
		super(tableManager);
	}
...
//		createToolItemByLotOut(tBar);
	...
	protected void newAdapter() {
		...
		BJOtherOutLineBlockDialog olbd = new BJOtherOutLineBlockDialog(UI.getActiveShell(),
	...
	protected void editAdapter() {
		try {
			if(selectedOut != null && selectedOut.getObjectRrn() != null) {
				...
				BJOtherOutLineBlockDialog cd = new BJOtherOutLineBlockDialog(UI.getActiveShell(),
