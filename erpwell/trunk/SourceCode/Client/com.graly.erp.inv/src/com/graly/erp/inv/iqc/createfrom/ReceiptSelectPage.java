...
public class ReceiptSelectPage extends FlowWizardPage {
	private static final Logger logger = Logger.getLogger(ReceiptSelectPage.class);
	private static String RECEIPTLINESELECT_NEXT = "receiptLineSelect";

	private IqcCreateWizard wizard;
	private ReceiptSelectSection section;
	private Receipt selectedReceipt;
	
	public ReceiptSelectPage(String pageName, Wizard wizard, String defaultDirect) {
	...
	public void createControl(Composite parent) {
        ...
        // create section
		section = new ReceiptSelectSection(adTable, this);
	...
	public ReceiptSelectSection getSection() {
		return section;
	}
}
