...
public class BJOtherOutLineEntryBlock extends OutLineEntryBlock {
	private static final Logger logger = Logger.getLogger(BJOtherOutLineEntryBlock.class);
	protected final String REPORT_FILE_NAME = "spares_oout_report.rptdesign";
	...
	public BJOtherOutLineEntryBlock(ADTable parentTable, Object parentObject,
...
//	}
	...
	protected void registerPages(DetailsPart detailsPart) {
		try {
			...
			detailsPart.registerPage(klass, new BJOtherOutLineProperties(this, table, getParentObject(),flag));
		} catch (Exception e) {
