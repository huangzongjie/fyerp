...
public class DeliveryLotQtySetupDialog extends TitleAreaDialog {
	...
	public DeliveryLotQtySetupDialog(Shell parentShell, MovementWorkShopLine movementLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
