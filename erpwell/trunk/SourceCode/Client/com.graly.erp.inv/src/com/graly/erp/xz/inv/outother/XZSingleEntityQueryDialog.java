 ...
 * */
public class XZSingleEntityQueryDialog extends SingleQueryDialog {
	Logger logger = Logger.getLogger(XZSingleEntityQueryDialog.class);
	
	protected TableViewer tableViewer;
	protected ADBase selectEntity;
	protected String tempSearchCondition;
	
	public XZSingleEntityQueryDialog() {
		super();
	}
	
	public XZSingleEntityQueryDialog(TableListManager listTableManager,
			IManagedForm managedForm, String whereClause, int style){
		super(listTableManager, managedForm, whereClause, style);
	}
	
	public XZSingleEntityQueryDialog(StructuredViewer viewer, Object object) {
		super();
