...
public class LotTrsSection extends TransferLineLotSection {
	...
	public LotTrsSection(ADTable adTable, TransferLineLotDialog parentDialog) {
	...
	protected void saveAdapter() {
		try {
			if (validate()) {
				...
				INVManager invManager = Framework.getService(INVManager.class);
				transfer = invManager.saveMovementTransferLine(transfer, lines,
						Env.getUserRrn());
