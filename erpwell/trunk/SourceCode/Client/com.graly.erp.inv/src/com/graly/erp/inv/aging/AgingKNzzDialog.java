...
public class AgingKNzzDialog extends EntityQueryDialog {

	public AgingKNzzDialog(Shell parent, EntityTableManager tableManager, IRefresh irefresh) {
...
//			iRefresh.refresh();
			...
			String report = "aging_kn_zz.rptdesign";
