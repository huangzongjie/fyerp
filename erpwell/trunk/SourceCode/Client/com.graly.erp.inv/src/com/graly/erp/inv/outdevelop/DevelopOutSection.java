...
import com.graly.erp.inv.outother.ByLotOutDialog;
...
public class DevelopOutSection extends OutSection {	
	private static final Logger logger = Logger.getLogger(DevelopOutSection.class);
	private static final String TABLE_NAME = "INVMovementOutDevelopLine";
	...
	public DevelopOutSection(EntityTableManager tableManager){
		super(tableManager);
	}
	...
	protected void newAdapter() {
		...
		DevelopOutLineBlockDialog olbd = new DevelopOutLineBlockDialog(UI.getActiveShell(),
...
//			refreshSection();
	...
	protected void queryAdapter() {
		if (queryDialog != null) {
			...
			queryDialog =  new MaterialWCAndInvoiceQueryDialog(UI.getActiveShell(), tableManager, this, Documentation.DOCTYPE_DOU);
			queryDialog.open();
		}
	}
	...
	protected void createToolItemByLotOut(ToolBar tBar) {
		itemByLotOut = new AuthorityToolItem(tBar, SWT.PUSH, Constants.KEY_DOU_LOTOUT);
	...
	protected void editAdapter() {
		try {
			if(selectedOut != null && selectedOut.getObjectRrn() != null) {
				...
				DevelopOutLineBlockDialog cd = new DevelopOutLineBlockDialog(UI.getActiveShell(),
	...
	protected void createToolItemNew(ToolBar tBar) {
		itemNew = new AuthorityToolItem(tBar, SWT.PUSH, Constants.KEY_DOU_NEW);
	...
	protected void createToolItemEditor(ToolBar tBar) {
		itemEdit = new AuthorityToolItem(tBar, SWT.PUSH, Constants.KEY_DOU_EDIT);
	...
	protected void createToolItemDelete(ToolBar tBar) {
		itemDelete = new AuthorityToolItem(tBar, SWT.PUSH, Constants.KEY_DOU_DELETE);
