...
public class BJInLineEntryBlock extends ParentChildEntityBlock {
	Logger logger = Logger.getLogger(BJInLineEntryBlock.class);
	...
	public BJInLineEntryBlock(ADTable parentTable, Object parentObject, String whereClause, ADTable childTable,boolean flag) {
	...
	protected void registerPages(DetailsPart detailsPart) {
		try {
			...
			detailsPart.registerPage(klass, new BJInLineProperties(this, table, getParentObject()));
		} catch (Exception e) {
...
//					in = invManager.approvePinMovementIn(in, flag, Env.getUserRrn());
					invManager.bjApproveMovementIn(in, MovementIn.InType.PIN,false,false, Env.getUserRrn(),true);
