...
public class WorkShopReclaimLineLotSection extends LotMasterSection {
	private static final Logger logger = Logger.getLogger(WorkShopReclaimLineLotSection.class);
	protected ToolItem itemPrintLot;
	private MovementWorkShopReclaim mt;
	...
	public WorkShopReclaimLineLotSection(WorkShopReclaimLineLotDialog parentDialog, ADTable adTable) {
		super(adTable, parentDialog);
	}
	
	public WorkShopReclaimLineLotSection(WorkShopReclaimLineLotDialog parentDialog, ADTable adTable,
			MovementWorkShopReclaim mt, MovementWorkShopLine transferLine, boolean isView) {
		super(adTable, parentDialog);
		this.mt = mt;
	...
	public WorkShopReclaimLineLotSection(WorkShopReclaimLineLotDialog olld, ADTable adTable,
			MovementWorkShopReclaim mt, MovementWorkShopLine transferLine,
...
//		createToolItemPrintLot(tBar);
			...
			if(lotId != null && !"".equals(lotId)) {				
				...
				if(validLot(lot)) {
					...
					if(Lot.LOTTYPE_BATCH.equals(lot.getLotType())
						...
						ReclaimLotQtySetupDialog trsQtyDialog = new ReclaimLotQtySetupDialog(UI.getActiveShell(),
								null, lot, wh);
	...
	protected void saveAdapter() {
		try {
			if(validateAll()) {
				INVManager invManager = Framework.getService(INVManager.class);
				mt = (MovementWorkShopReclaim) invManager.saveMovementWorkShopLineLot(mt, lines, Env.getOrgRrn());
				UI.showInfo(Message.getString("common.save_successed"));
				setIsSaved(true);
				((WorkShopReclaimLineLotDialog)parentDialog).buttonPressed(IDialogConstants.CANCEL_ID);
			}
		} catch(Exception e) {
