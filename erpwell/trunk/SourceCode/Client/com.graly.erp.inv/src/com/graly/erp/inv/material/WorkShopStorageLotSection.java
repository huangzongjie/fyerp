...
public class WorkShopStorageLotSection extends LotMasterSection {
	private VWorkShopStorage selectedLine;
	protected ToolItem itemPrint;
	
	public WorkShopStorageLotSection(){
		super();
	}
	
	public WorkShopStorageLotSection(ADTable adTable, LotDialog parentDialog, VWorkShopStorage selectedLine) {
...
//			if(!Lot.LOTTYPE_SERIAL.equals(selectedLine.getLotType())) {
				...
				list = invManager.getWorkShopLotStorage(selectedLine.getWarehouseRrn(), selectedLine.getMaterialRrn());
//			} else {
