...
public class ReclaimLotQtySetupDialog extends TitleAreaDialog {
	...
	public ReclaimLotQtySetupDialog(Shell parentShell, MovementWorkShopLine movementLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
