...
public class IqcLineDialog extends InClosableTitleAreaDialog {
	private static final Logger logger = Logger.getLogger(IqcLineDialog.class);
	private static int MIN_DIALOG_WIDTH = 700;
	private static int MIN_DIALOG_HEIGHT = 450;
	private static String TABLE_NAME = "INVIqcLine";
	private String PREFIX = " iqcRrn = ";
	
	protected ADTable table;
	protected ManagedForm managedForm;
	protected IqcLineSection prListSection;
	protected Iqc iqc;

	public IqcLineDialog(Shell parent, Iqc iqc) {
        super(parent);
        this.iqc = iqc;
    }
	
	public IqcLineDialog(Shell parent, ADTable table, Iqc iqc){
		this(parent, iqc);
		this.table = table;
	}
	...
	protected void createFormContent(Composite composite) {
		...
		prListSection = new IqcLineSection(new EntityTableManager(table), iqc, managedForm);
		prListSection.setWhereClause(getWhereClause());
	...
	protected String getWhereClause() {
		...
		return PREFIX + iqc.getObjectRrn();
	}
}
