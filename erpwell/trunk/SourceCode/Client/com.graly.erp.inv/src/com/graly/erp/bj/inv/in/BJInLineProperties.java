...
public class BJInLineProperties extends ChildEntityProperties {
	private String PREFIX = " movementRrn = '";
	
	public BJInLineProperties() {
		super();
    }
	
	public BJInLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
	...
	protected void createSectionContent(Composite client) {
		...
		//init Locator
		BJInLineEntryBlock block = (BJInLineEntryBlock)getMasterParent();
...
//		new ToolItem(tBar, SWT.SEPARATOR);
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			BJInLineEntryBlock block = (BJInLineEntryBlock)this.getMasterParent();
