...
public class XZInSection extends MasterSection {

	private static final Logger logger = Logger.getLogger(XZInSection.class);
	...
	public XZInSection(EntityTableManager tableManager) {
		super(tableManager);
	}
...
//		String CATEGORY_NEW_PO = "createPo";
	...
	protected void editAdapter() {
		try {
			if(selectedIn != null && selectedIn.getObjectRrn() != null) {
				...
				XZInLineDialog inLineDialog = new XZInLineDialog(UI.getActiveShell(), this.getTableManager().getADTable(), whereClause, selectedIn,
						adTable, false);
