...
public class WorkShopDeliveryLineProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(WorkShopDeliveryLineProperties.class);
	...
	public WorkShopDeliveryLineProperties() {
		super();
	}
	
	public WorkShopDeliveryLineProperties(EntityBlock masterParent, ADTable table, Object parentObject) {
		this(masterParent, table, parentObject, false);
	}
	
	public WorkShopDeliveryLineProperties(EntityBlock masterParent, ADTable table, Object parentObject, boolean flag) {
	...
	public void refresh() {
		super.refresh();
		WorkShopDeliveryLineEntryBlock block = (WorkShopDeliveryLineEntryBlock)getMasterParent();
...
//						newAdapter();
					...
					line = invManager.saveMovementWorkShopDeliveryLine(mm, line, Env.getUserRrn());
	...
	protected boolean isContainsSameMaterialInLines(MovementWorkShopDelivery mm, MovementWorkShopLine line) {
	...
	protected List<MovementWorkShopLineLot> getLineLotList(MovementWorkShopDelivery mtrs, MovementWorkShopLine line) throws Exception{
...
//		}
	...
	public ADBase createAdObject() throws Exception {
		...
		try {
			WorkShopDeliveryLineEntryBlock block = (WorkShopDeliveryLineEntryBlock)this.getMasterParent();
