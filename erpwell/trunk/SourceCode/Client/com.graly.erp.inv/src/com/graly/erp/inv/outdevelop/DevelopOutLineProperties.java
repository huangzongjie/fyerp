...
import com.graly.erp.inv.outother.OtherOutLineProperties;
...
public class DevelopOutLineProperties extends OutLineProperties {
	private static final Logger logger = Logger.getLogger(DevelopOutLineProperties.class);
	private String PREFIX = " movementRrn = '";
	
	public DevelopOutLineProperties() {
		super();
    }
	
	public DevelopOutLineProperties(EntityBlock masterParent, ADTable table, Object parentObject,boolean flag) {
	...
	public void refresh() {
		super.refresh();
		DevelopOutLineEntryBlock block = (DevelopOutLineEntryBlock)getMasterParent();
...
//						newAdapter();
					...
					line = invManager.saveMovementOutLine(mm, line, MovementOut.OutType.DOU, Env.getUserRrn());
			...
			logger.error("Error at DevelopOutLineProperties saveAdapter() ", e);
