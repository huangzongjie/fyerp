...
public class DpkLotTrsSection extends DpkTransferLineLotSection {
	private static final Logger logger = Logger.getLogger(DpkLotTrsSection.class);
	public static final String TABLE_NAME = "DpkVUserWarehouse";
	...
	public static final String TRS_TYPE = "DpkTrsType";
	...
	public DpkLotTrsSection(ADTable adTable, DpkTransferLineLotDialog parentDialog) {
	...
	protected void saveAdapter() {
		try {
			if (validate()) {
				...
				INVManager invManager = Framework.getService(INVManager.class);
				transfer = invManager.saveMovementTransferLineDpk(transfer, lines,
						Env.getUserRrn());
