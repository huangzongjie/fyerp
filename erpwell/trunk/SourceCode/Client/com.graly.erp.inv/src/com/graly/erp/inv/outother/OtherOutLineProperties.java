...
public class OtherOutLineProperties extends OutLineProperties {
	private static final Logger logger = Logger.getLogger(OtherOutLineProperties.class);
	private String PREFIX = " movementRrn = '";
	
	public OtherOutLineProperties() {
		super();
    }
	
	public OtherOutLineProperties(EntityBlock masterParent, ADTable table, Object parentObject,boolean flag) {
	...
	public void refresh() {
		super.refresh();
		OtherOutLineEntryBlock block = (OtherOutLineEntryBlock)getMasterParent();
