...
public class UnqualifiedLotQtySetupDialog extends TitleAreaDialog {
	...
	public UnqualifiedLotQtySetupDialog(Shell parentShell, MovementWorkShopLine movementLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
	...
	protected BigDecimal getQtyOnhand() {
		try {
			if(warehouse != null || lot != null) {
				...
				qtyOnhand = invManager.getWorkShopLotStorage(Env.getOrgRrn(),
