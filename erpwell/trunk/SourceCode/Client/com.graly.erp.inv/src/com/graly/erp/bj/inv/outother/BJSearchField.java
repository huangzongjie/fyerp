 ...
 * ÷ÿ–¥SearchField
 * */
public class BJSearchField extends SearchField {

	public BJSearchField(String id, ADTable adTable, ADRefTable refTable,
			String whereClause, int style) {
		super(id, adTable, refTable, whereClause, style);
	}

	public BJSearchField(String id, TableViewer viewer, int style) {
    ...
    protected SelectionListener getSelectionListener() {
    	return new SelectionAdapter() {
    		public void widgetSelected(SelectionEvent e) {
    			...
    			BJSingleEntityQueryDialog singleDialog = new BJSingleEntityQueryDialog(
