...
public class BJPurInLineEntryBlock extends ParentChildEntityBlock {
	Logger logger = Logger.getLogger(BJPurInLineEntryBlock.class);
	...
	public BJPurInLineEntryBlock(ADTable parentTable, Object parentObject, String whereClause, ADTable childTable,boolean flag) {
	...
	protected void registerPages(DetailsPart detailsPart) {
		try {
			...
			detailsPart.registerPage(klass, new BJPurInLineProperties(this, table, getParentObject()));
		} catch (Exception e) {
	...
	public void createToolBar(Section section) {
		...
		new ToolItem(tBar, SWT.SEPARATOR);
		createToolItemPreviewAgain(tBar);
		createMenu(tBar);
		...
		try {
			...
			if (parentObject != null) {
				...
				if (approvedDialog.open() == Dialog.OK) {
					...
					in = invManager.bjApproveMovementIn2(in, MovementIn.InType.PIN,false,false, Env.getUserRrn(),true);
