...
public class PoLineLotSelectPage extends FlowWizardPage {
	...
	private PoLineLotSelectSection section;
	
	public PoLineLotSelectPage(String pageName, Wizard wizard, String defaultDirect) {
	...
	public void createControl(Composite parent) {
		ADTable adTablePo = wizard.getContext().getTable(CreateContext.TableName_Lot);
		ADTable adTablePoLine = wizard.getContext().getTable(CreateContext.TableName_PoLine);
        ...
        // create section
		section = new PoLineLotSelectSection(adTablePo, this, wizard, adTablePoLine);
