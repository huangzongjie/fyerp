...
public class AdjustOutQtySetupDialog extends TitleAreaDialog {
	...
	public AdjustOutQtySetupDialog(Shell parentShell, MovementLine movementLine, Lot lot, Warehouse warehouse) {
		super(parentShell);
