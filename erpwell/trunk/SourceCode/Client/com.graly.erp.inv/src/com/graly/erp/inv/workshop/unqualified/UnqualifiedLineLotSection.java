...
public class UnqualifiedLineLotSection extends LotMasterSection {
	private static final Logger logger = Logger.getLogger(UnqualifiedLineLotSection.class);
	protected ToolItem itemPrintLot;
	private MovementWorkShopUnqualified mt;
	...
	public UnqualifiedLineLotSection(UnqualifiedLineLotDialog parentDialog, ADTable adTable) {
		super(adTable, parentDialog);
	}
	
	public UnqualifiedLineLotSection(UnqualifiedLineLotDialog parentDialog, ADTable adTable,
			MovementWorkShopUnqualified mt, MovementWorkShopLine transferLine, boolean isView) {
		super(adTable, parentDialog);
		this.mt = mt;
	...
	public UnqualifiedLineLotSection(UnqualifiedLineLotDialog olld, ADTable adTable,
			MovementWorkShopUnqualified mt, MovementWorkShopLine transferLine,
...
//		createToolItemPrintLot(tBar);
	...
	protected void saveAdapter() {
		try {
			if(validateAll()) {
				INVManager invManager = Framework.getService(INVManager.class);
				mt = (MovementWorkShopUnqualified) invManager.saveMovementWorkShopLineLot(mt, lines, Env.getOrgRrn());
				UI.showInfo(Message.getString("common.save_successed"));
				setIsSaved(true);
				((UnqualifiedLineLotDialog)parentDialog).buttonPressed(IDialogConstants.CANCEL_ID);
			}
		} catch(Exception e) {
