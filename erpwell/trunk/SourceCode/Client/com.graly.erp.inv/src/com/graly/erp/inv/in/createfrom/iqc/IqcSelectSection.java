...
public class IqcSelectSection {
	private static final Logger logger = Logger.getLogger(IqcSelectSection.class);
	private static String IqcWhereClause = " isIn != 'Y' AND docStatus = '" + Iqc.STATUS_APPROVED + "' ";
	private IqcSelectPage parentPage;
	private ADTable adTable;
	private ManagedForm form;
	private EntityListTableManager tableManager;
	private TableViewer viewer;

	public IqcSelectSection(ADTable table, IqcSelectPage parentPage) {
		this.adTable = table;
	...
	protected void createSectionContent(Composite client) {
		try {
			...
			EntityItemInput input = new EntityItemInput(adTable, IqcWhereClause, null);
