...
public class AgingBTzcDialog extends EntityQueryDialog {

	public AgingBTzcDialog(Shell parent, EntityTableManager tableManager, IRefresh irefresh) {
...
//			iRefresh.refresh();
			...
			String report = "aging_bt_zc.rptdesign";
