...
public class ReceiptLineQueryEntryPage extends FormPage {
	
	private static final Logger logger = Logger.getLogger(SectionEntryPage.class);
	protected IManagedForm form;
	protected ReceiptLineQuerySection masterSection;
	
	public ReceiptLineQueryEntryPage(FormEditor editor, String id, String name,
			ADTable table) {
	...
	protected void createSection(ADTable adTable) {
		masterSection = new ReceiptLineQuerySection(adTable);
	}

	public ReceiptLineQuerySection getMasterSection() {
