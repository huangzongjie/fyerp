...
public class XZEntityQueryDialog4WC extends EntityQueryDialog {
	public static final String FIELD_ID_WAREHOUSE_RRN = "warehouseRrn";

	public XZEntityQueryDialog4WC(Shell parent, EntityTableManager tableManager, IRefresh irefresh) {
