...
public class TransferLineEntryBlock extends ParentChildEntityBlock {
	private static final Logger logger = Logger.getLogger(TransferLineEntryBlock.class);
	protected ToolItem itemOptionalLot;
	protected ToolItem itemApprove;
	protected ToolItem itemPreview;
	protected TransferLineProperties page;
	...
	public TransferLineEntryBlock(ADTable parentTable, Object parentObject,
	...
	protected void registerPages(DetailsPart detailsPart) {
		try{
			...
			page = new TransferLineProperties(this, table, getParentObject(), flag);
	...
	protected void setChildObjectStatusChanged() {
		TransferLineProperties page = (TransferLineProperties)this.detailsPart.getCurrentPage();
...
//		});
	...
	protected void lotAdapter() {
		try {
				...
				TransferLineLotDialog od = new TransferLineLotDialog(UI.getActiveShell(),
