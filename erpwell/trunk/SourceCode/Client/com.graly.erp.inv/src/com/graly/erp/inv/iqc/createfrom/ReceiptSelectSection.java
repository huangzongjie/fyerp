...
public class ReceiptSelectSection implements IRefresh{
	private static final Logger logger = Logger.getLogger(ReceiptSelectSection.class);
	private static String ReceiptWhereClause = " isIqc != 'Y' " + " AND docStatus='" + Iqc.STATUS_APPROVED + "' ";
	private ReceiptSelectPage parentPage;
	...
	public ReceiptSelectSection(ADTable table, ReceiptSelectPage parentPage) {
		this.adTable = table;
	...
	protected void createSectionContent(Composite client) {
		try {
			...
			List<Receipt> ls = adManager.getEntityList(Env.getOrgRrn(), Receipt.class, Env.getMaxResult(), ReceiptWhereClause, " objectRrn ASC");
