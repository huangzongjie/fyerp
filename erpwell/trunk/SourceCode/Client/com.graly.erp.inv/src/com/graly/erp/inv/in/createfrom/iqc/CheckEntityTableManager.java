...
import com.graly.erp.inv.in.createfrom.po.PoLineSelectSection;
...
public class CheckEntityTableManager extends EntityTableManager {
	...
	private IqcLineLotSelectSection parentLotSection;
	private IqcLineSelectSection parentIqcLineSection;
	private PoLineSelectSection parentPoLineSection;
	
	public CheckEntityTableManager(ADTable adTable, IqcLineLotSelectSection parentLotSection){
		super(adTable);
		this.parentLotSection = parentLotSection;
	}
	
	public CheckEntityTableManager(ADTable adTable, IqcLineSelectSection parentIqcLineSection){
		super(adTable);
		this.parentIqcLineSection = parentIqcLineSection;
	}
	
	public CheckEntityTableManager(ADTable adTable, PoLineSelectSection parentPoLineSection){
		super(adTable);
	...
	private void updateParentSection(boolean isChecked) {
		if(parentLotSection != null) {
			parentLotSection.updateParentPage(isChecked);
		}
		if(parentIqcLineSection != null) {
			parentIqcLineSection.updateParentPage(isChecked);
		}
