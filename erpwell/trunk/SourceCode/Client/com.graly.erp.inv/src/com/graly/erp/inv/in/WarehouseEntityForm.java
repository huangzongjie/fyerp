...
public class WarehouseEntityForm extends EntityForm {

	public WarehouseEntityForm(Composite parent, int style, ADTab tab, IMessageManager mmng) {
		super(parent, style, tab, mmng);
	}

	public WarehouseEntityForm(Composite parent, int style, Object object, ADTab tab, IMessageManager mmng) {
