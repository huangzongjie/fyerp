...
public class BJPoLineLotSelectSection {
	private static final Logger logger = Logger.getLogger(BJPoLineLotSelectSection.class);
	...
	private BJPoLineLotSelectPage parentPage;
	...
	public BJPoLineLotSelectSection(ADTable table, BJPoLineLotSelectPage parentPage, BJPoCreateWizard wizard, ADTable adTablePoLine) {
