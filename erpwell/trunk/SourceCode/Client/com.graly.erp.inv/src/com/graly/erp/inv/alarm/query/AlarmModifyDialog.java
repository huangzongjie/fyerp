 ...
 * 用于修改质检备注信息
 */
public class AlarmModifyDialog extends InClosableTitleAreaDialog {
	protected ManagedForm managedForm;
	private ADTable adTable;
	private AlarmData alarmData;
	private EntityForm entityForm;

	public AlarmModifyDialog(Shell parentShell, AlarmData alarmData,ADTable adTable) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		configureBody(body);
		entityForm = new EntityForm(body, SWT.NONE, alarmData, adTable, null);
