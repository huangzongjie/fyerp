...
public class InSection extends MasterSection {

	private static final Logger logger = Logger.getLogger(InSection.class);
	...
	public InSection(EntityTableManager tableManager) {
		super(tableManager);
	}
	...
	protected void editAdapter() {
		try {
			if(selectedIn != null && selectedIn.getObjectRrn() != null) {
				...
				InLineDialog inLineDialog = new InLineDialog(UI.getActiveShell(), this.getTableManager().getADTable(), whereClause, selectedIn,
						adTable, false);
