package com.graly.erp.vdm.vendor.purchase;
...
public class VendorPurchaseQueryDialog extends ExtendDialog {
	private InnerQueryDialog queryDialog;
	private EntityTableManager tableManager;
	
	public VendorPurchaseQueryDialog() {
		super();
	...
	class InnerQueryDialog extends EntityQueryDialog{
	    ...
	    protected void okPressed() {
			try {
				String report = "vendorpurchase_report.rptdesign";
