...
import com.graly.mes.prd.viewer.ProcessTreeManager;
import com.graly.mes.prd.workflow.graph.def.ProcessDefinition;
import com.graly.framework.runtime.Framework;
import com.graly.framework.runtime.exceptionhandler.ExceptionHandlerManager;

public class ProcessFlowForm extends Form {

	private static final Logger logger = Logger.getLogger(ProcessFlowForm.class);
	private static final String FIELD_ID = "children";
	protected IMessageManager mmng;
	protected ProcessProperties properties;
	protected Button btnEdit;

	public ProcessFlowForm(ProcessProperties properties, Composite parent,
	...
	public void createForm() {
		...
		btnEdit = toolkit.createButton(buttonBar, Message
				.getString("common.edit"), SWT.NULL);
			...
			public void widgetSelected(SelectionEvent e) {
				if (properties.saveToObject()) {
					for (Form detailForm : properties.getDetailForms()) {
						PropertyUtil.copyProperties(properties.getAdObject(),
					...
					ProcessDialog d = new ProcessDialog(UI.getActiveShell(), input,	ProcessFlowForm.this);
	...
	public void addFields() {
		try {
			ProcessTreeManager treeManager = new ProcessTreeManager();
