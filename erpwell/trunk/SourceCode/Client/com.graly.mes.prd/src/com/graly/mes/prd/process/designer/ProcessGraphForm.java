...
public class ProcessGraphForm extends AbstractGraphForm {

	private static String contributorId = "com.graly.mes.prd.designer.procedure";
	private ProcessDialog dialog;

	
	public ProcessGraphForm(ProcessDialog dialog, FormToolkit toolkit, Composite parent, IEditorInput input) {
