...
public abstract class AbstractContentProvider implements ContentProvider{
	...
	protected abstract SemanticElement getNodeSemanticElement(NodeContainer nodeContainer, Element notationInfo, int index);
...
//	 }	
	...
	public String toNotationInfoXml(RootContainer rootContainer) {
