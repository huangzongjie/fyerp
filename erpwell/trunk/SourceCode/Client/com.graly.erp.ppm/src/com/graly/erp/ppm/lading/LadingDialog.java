...
public class LadingDialog extends SalePlanDialog {
	public static final String DIALOG_ID = "com.graly.erp.ppm.lading.LadingDialog";
	...
	public void initTableViewer() {
		if (salePlanDialogForm.getViewer().getTable().getSelection().length > 0) {
			...
			LadingEditor editor = (LadingEditor) getParent();
			LadingEntryPage page = (LadingEntryPage) editor.getActivePageInstance();
