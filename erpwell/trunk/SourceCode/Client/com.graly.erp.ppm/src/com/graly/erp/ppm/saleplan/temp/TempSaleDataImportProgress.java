...
public class TempSaleDataImportProgress extends SaleDataImportProgress {
	private static final Logger logger = Logger.getLogger(TempSaleDataImportProgress.class);
	protected String tpsId;

	public TempSaleDataImportProgress(Mps mps, String fileUrl, ADTable adTable,
	...
	protected void readExcelRow(HSSFRow row, TpsLine tpsLine) {
		int j = 0;
