...
public class BomTreeManager extends TreeViewerManager {
	private static final Logger logger = Logger.getLogger(BomTreeManager.class);
	private ADTable adTable;

	public BomTreeManager(int style, ADTable adTable) {
		super(style);
		this.adTable = adTable;
	}
	
	public BomTreeManager(ADTable adTable) {
		super();
		this.adTable = adTable;
	}
	...
	protected ItemAdapterFactory createAdapterFactory() {
		...
		try {
			ItemAdapter mpsLineBomAdapter = new BomTreeItemAdapter();
			factory.registerAdapter(List.class, mpsLineBomAdapter);
			factory.registerAdapter(MpsLineBom.class, mpsLineBomAdapter);
		} catch (Exception e) {
	...
	protected StructuredViewer newViewer(Composite parent, FormToolkit toolkit) {
		...
		fillColumns(tree, getColumns(), getColumnsHeader(), getColumnSize());
