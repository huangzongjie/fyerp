 ...
 * 继承父类主要取消查询和导入功能
 */
public class TpsPrepareEntityBlock extends SalePlanEntityBlock {
	protected ToolItem itemExport;
	protected ToolItem itemApprove;
	
	public TpsPrepareEntityBlock(EntityTableManager tableManager, String whereClause,
			Object parentObject) {
		super(tableManager, whereClause, parentObject);
	}

	public TpsPrepareEntityBlock(EntityTableManager tableManager) {
		super(tableManager);
	}
	...
	protected void uploadAdapter() {
		try {
			...
			if (selectedFile != null) {
				...
				MpsDataImportProgress progress = new PrepareTempSaleDataImportProgress((Mps)getParentObject(),
