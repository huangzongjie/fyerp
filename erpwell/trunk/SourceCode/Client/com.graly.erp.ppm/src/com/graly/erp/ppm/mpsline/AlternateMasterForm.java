...
public class AlternateMasterForm extends Form {
	private static final Logger logger = Logger.getLogger(AlternateMasterForm.class);
	private static final String PREFIX = " materialRrn = ";
	protected ADTable table;
	protected TableViewer viewer;
	protected AlternateDialog parentDialog;
	...
	public AlternateMasterForm(Composite parent, int style, ADTable table,
			Long rootMaterialRrn, MpsLineBom mpsLineBom, AlternateDialog parentDialog) {
		super(parent, style, mpsLineBom);
        ...
        try {
        	if(object != null) {
        		if(object != null) {
            		...
            		+ "' AND childRrn = " + ((MpsLineBom)getObject()).getMaterialRrn() + " ";
            	}
        	}
        } catch (Exception e) {
	...
	private String getActualPath() {
		...
		String path = ((MpsLineBom)getObject()).getPath();
