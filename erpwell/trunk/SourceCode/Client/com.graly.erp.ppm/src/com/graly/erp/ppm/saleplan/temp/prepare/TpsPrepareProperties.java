...
public class TpsPrepareProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(TpsPrepareProperties.class);
	public static final String DELIVER_DATE = "dateDelivered";
	public static final String MATERIAL_ID = "materialRrn";
	
	public TpsPrepareProperties() {
		super();
	}

	public TpsPrepareProperties(EntityBlock masterParent, ADTable table) {
