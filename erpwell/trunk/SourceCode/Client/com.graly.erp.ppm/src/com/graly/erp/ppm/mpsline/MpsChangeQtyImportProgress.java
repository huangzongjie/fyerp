...
public class MpsChangeQtyImportProgress extends MpsDataImportProgress {
	private static final Logger logger = Logger.getLogger(MpsChangeQtyImportProgress.class);
	...
	public MpsChangeQtyImportProgress(Mps mps, String fileUrl, ADTable adTable,
			MpsEntityBlock mpsEntityBlock) {
