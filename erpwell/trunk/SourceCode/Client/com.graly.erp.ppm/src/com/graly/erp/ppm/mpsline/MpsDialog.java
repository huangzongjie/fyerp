...
public class MpsDialog extends SalePlanDialog {
	public static final String DIALOG_ID = "com.graly.erp.ppm.mpsline.MpsDialog";
	...
	public void initTableViewer() {
		if (salePlanDialogForm.getViewer().getTable().getSelection().length > 0) {
			...
			MpsEditor editor = (MpsEditor) getParent();
			MpsEntryPage page = (MpsEntryPage) editor.getActivePageInstance();
