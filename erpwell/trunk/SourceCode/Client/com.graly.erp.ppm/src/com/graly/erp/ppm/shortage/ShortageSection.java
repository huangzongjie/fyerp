...
public class ShortageSection extends MasterSection {
	private static final Logger logger = Logger.getLogger(ShortageSection.class);
	protected TableListManager tableListManager;
	protected List input;
			
	public ShortageSection() {
		super();
	}

	public ShortageSection(TableListManager tableListManager) {
...
//		createToolItemRefresh(tBar);
	...
	public void refresh() {
		try{
			...
			boolean isIncludeTransit = ((ShortageQueryDialog.InnerQueryDialog)queryDialog).getIsIncludeTransit();
