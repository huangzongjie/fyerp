...
public class POForm extends EntityForm {
	...
	public POForm(Composite parent, int style, Object object, ADTable table, IMessageManager mmng) {
		super(parent, style, object, table, mmng);
	}
    
	public POForm(Composite parent, int style, Object object, ADTab tab, IMessageManager mmng) {
