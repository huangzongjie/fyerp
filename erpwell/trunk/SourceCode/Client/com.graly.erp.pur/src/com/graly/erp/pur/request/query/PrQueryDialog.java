	...
	protected void setQueryDialogToSection() {
		if(getParent() instanceof EntityEditor){
			...
			if(editor.getActivePageInstance() instanceof SectionEntryPage){
				...
				((PrQuerySection)section).setExtendDialog(this);
			}
		}
	}
