...
public class XZRequestLineDataImportProgress implements IRunnableWithProgress {
	private static final Logger logger = Logger.getLogger(XZRequestLineDataImportProgress.class);
	private XZRequisitionLineEntityBlock parentBlock;
	...
	public XZRequestLineDataImportProgress() {
	}

	public XZRequestLineDataImportProgress(Requisition request, String fileUrl, ADTable adTable, XZRequisitionLineEntityBlock parentBlock) {
...
//		prLine.setOrgRrn(Env.getOrgRrn());
	...
	public XZRequisitionLineEntityBlock getParentBlock() {
		return parentBlock;
	}
