...
import com.graly.erp.pur.po.POForm;
...
public class PoDownForm extends EntityForm{
	private static final Logger logger = Logger.getLogger(POForm.class);
	...
	public PoDownForm(Composite parent, int style, Object object, ADTable table, IMessageManager mmng) {
		super(parent, style, object, table, mmng);
	}
    
	public PoDownForm(Composite parent, int style, Object object, ADTab tab, IMessageManager mmng) {
