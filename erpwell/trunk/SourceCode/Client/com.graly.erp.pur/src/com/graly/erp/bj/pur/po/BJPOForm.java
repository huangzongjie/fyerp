...
public class BJPOForm extends EntityForm {
	private static final Logger logger = Logger.getLogger(BJPOForm.class);
	...
	public BJPOForm(Composite parent, int style, Object object, ADTable table, IMessageManager mmng) {
		super(parent, style, object, table, mmng);
	}
    
	public BJPOForm(Composite parent, int style, Object object, ADTab tab, IMessageManager mmng) {
