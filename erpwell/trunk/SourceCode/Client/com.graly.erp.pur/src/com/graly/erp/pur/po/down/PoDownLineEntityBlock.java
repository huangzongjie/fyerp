...
public class PoDownLineEntityBlock extends ParentChildEntityBlock{

	private static final Logger logger = Logger.getLogger(PoDownLineEntityBlock.class);
	...
	public PoDownLineEntityBlock(ADTable parentTable, Object parentObject, String whereClause, ADTable childTable, boolean flag) {
		...
		this.setTableManager(new PoColorEntityTableManager(childTable));
		this.flag = flag;
	}
	...
	protected void registerPages(DetailsPart detailsPart) {
		try{
			...
			if (ManagerDialogExtensionPoint.getManager("com.graly.erp.po.model.VPoDown") != null){
				EntityProperties page = ManagerDialogExtensionPoint.getManager("com.graly.erp.po.model.VPoDown");
				page.setTable(table);
...
//				detailsPart.registerPage(klass, new ChildEntityProperties(this, table, getParentObject()));
				detailsPart.registerPage(klass, new deleteAllButtonChildProperties(this, table, getParentObject()));
			}
		} catch (Exception e){
	...
	protected void createMasterPart(final IManagedForm managedForm, Composite parent) {
		...
		((PoColorEntityTableManager)this.getTableManager()).setPoDownLineEntityBlock(this);
...
//		itemApproveUnitPrice.setEnabled(false);
	...
	protected void createParentContent(Composite client) {
		...
		for (ADTab tab : parentTable.getTabs()) {
			...
			PoDownForm itemForm = new PoDownForm(getTabs(), SWT.NONE, parentObject, tab, mmng);
...
//			itemLargeAmountApprove.setEnabled(false);
	...
	protected void setChildObjectStatusChanged() {
		PoDownProperties page = (PoDownProperties) this.detailsPart.getCurrentPage();
		try {
			selectedPOline = null;
