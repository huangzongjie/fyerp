...
public class POEntryPage extends SectionEntryPage {
	...
	protected void createSection(ADTable adTable) {
		...
		masterSection = new POSection(new EntityTableManager(adTable));
