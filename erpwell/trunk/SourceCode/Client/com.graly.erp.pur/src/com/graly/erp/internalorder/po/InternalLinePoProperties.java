...
public class InternalLinePoProperties extends ChildEntityProperties {
	private static final Logger logger = Logger.getLogger(InternalLinePoProperties.class);
	...
	public InternalLinePoProperties() {
		super();
    }
	
	public InternalLinePoProperties(EntityBlock masterParent, ADTable table, Object parentObject, boolean flag) {
	...
	public void refresh() {
		super.refresh();
		InternalLinePoEntryBlock block = (InternalLinePoEntryBlock)getMasterParent();
