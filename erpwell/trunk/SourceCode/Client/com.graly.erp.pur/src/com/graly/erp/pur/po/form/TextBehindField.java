...
public class TextBehindField extends TextField {
	...
	public TextBehindField(String id) {
		this(id, SWT.BORDER);
	}

	public TextBehindField(String id, int style) {
		super(id);
		this.mStyle = style;
	}
	
	public TextBehindField(String id, boolean autoUpper) {
		super(id);
	...
	public void createContent(Composite composite, FormToolkit toolkit) {
		...
		if (labelStr != null) {
			text = toolkit.createText(composite, (String)getValue(), mStyle | SWT.RIGHT);
...
//      gd.grabExcessHorizontalSpace = true;
    ...
    public Label getLabelControl() {
        Control[] ctrls = getControls();
        return ctrls.length > 1 ? (Label)ctrls[ctrls.length-1] : null;
    }
