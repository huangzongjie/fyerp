...
public class QueryBaseForm extends EntityForm {
	
	private static final String TABLE_NAME = "QueryTime";
	private ADTable formAdTable;
	public QueryBaseForm(Composite parent, int style, Object object) {
